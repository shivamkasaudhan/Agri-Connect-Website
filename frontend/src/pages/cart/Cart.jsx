...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_qTvrP8eNfTKVCK",
      key_secret: "UCqtb8X2QDdnjA6lF1AN97cJ",
      ...
      handler: async function (response) {
        ...
        try {
          // Send order information to MongoDB endpoint
          const orderResponse = await axios.post('http://localhost:8000/order', orderInfo);
